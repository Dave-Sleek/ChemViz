...
export function About() {
  ...
  return (
    <div className="min-h-full bg-[#0B0E14] overflow-y-auto">
      {/* Hero Section */}
      <section className="relative py-24 px-8 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          <motion.h1 
            ...
            className="text-5xl lg:text-6xl font-black text-white tracking-tighter mb-6"
          >
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8">
          {values.map((v, idx) => (
            <motion.div 
              ...
              className="bg-[#161B22] border border-slate-800 p-8 rounded-[2rem] hover:border-blue-500/50 transition-colors group"
            >
              <div className="w-12 h-12 bg-[#0B0E14] rounded-2xl flex items-center justify-center mb-6 border border-slate-800 group-hover:scale-110 transition-transform">
                {v.icon}
              </div>
      ...
      {/* Mission Section */}
      <section className="px-8 py-24 bg-[#161B22]/30 border-y border-slate-800">
        <div className="max-w-4xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-3xl font-black text-white tracking-tight mb-6">Our Mission</h2>
          ...
          <div className="relative">
            ...
            <div className="relative bg-[#0B0E14] border border-slate-800 rounded-[3rem] p-12 overflow-hidden">
              <div className="absolute top-0 right-0 p-8 text-[120px] font-black text-white/5 select-none leading-none">
                H<sub className="text-[60px]">2</sub>O
              </div>
              <div className="relative z-10">
                <span className="text-blue-500 font-black text-5xl">100%</span>
                <p className="text-white font-bold text-xl mt-2">Open Access</p>
                <p className="text-slate-500 text-sm mt-4">Available for scientific exploration without account barriers or subscription friction.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 text-center">
        <p className="text-slate-600 font-medium text-sm">Molecufy — Laboratory v4.2.1</p>
        <p className="text-slate-700 text-xs mt-2">Connecting atoms to minds.</p>
      </section>
    </div>
  );
}
